...
export const STUDENTAPPURL = process.env.STUDENTAPPURL;
export const STUDENTALLAPPURL = process.env.STUDENTALLAPPURL;
export const COLLEGEAPPURL = process.env.COLLEGEAPPURL;